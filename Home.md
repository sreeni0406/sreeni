...
This the modes (or mode names) allow you to specify the Group properties that will be considered by Shiro as role 'names'.  The default is `href`.  The supported modes are the following:
